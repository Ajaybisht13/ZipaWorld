...
class RefrigeratedCargoAddressToPort extends Component {
          ...
          <View style = {{display:"flex", flexDirection:"column", padding :"2%",justifyContent:"space-between", marginTop:"10%", height:"100%", paddingBottom:"25%"}}>
           ...
           <TouchableOpacity style={this.state.borderColorId === 1? styles.border : styles.button} onPress={() => this.Select(1)}>
             ...
             {this.state.showOrigin ? 
              <View style = {{display:"flex", marginTop :"2%",flexDirection:"row", alignSelf:"center", width:"60%", justifyContent:"space-between"}}>
            ...
            <TouchableOpacity style={this.state.borderColorId === 2? styles.border : styles.button} onPress={() => this.Select(2)}>
              ...
              <View style = {{display:"flex", marginTop :"2%",flexDirection:"row", alignSelf:"center", width:"80%", justifyContent:"space-between"}}>
            ...
            <View style = {{ alignSelf:"center", width:"100%"}}>
              <View style = {{display:"flex", marginTop :"2%",flexDirection:"row", marginLeft:"20%"}}>
            ...
            <TouchableOpacity style={this.state.borderColorId === 5? styles.border : styles.button} onPress={() => this.Select(5)}>
              <View style = {{display:"flex", marginTop :"2%", flexDirection:"row", alignSelf:"center", width:"70%", justifyContent:"space-between"}}>
            ...
            <TouchableOpacity style={this.state.borderColorId === 7? styles.border : styles.button} onPress={() => this.Select(7)}>
              <View style = {{display:"flex", marginTop :"2%", flexDirection:"row", alignSelf:"center", width:"50%", justifyContent:"space-between"}}>
              <Icons name="box" size={40} color = "#000000"/>
            ...
            <TouchableOpacity style={this.state.borderColorId === 7? styles.border : styles.button} onPress={() => this.Select(7)}>
               ...
               {/* <View style = {{display:"flex", marginLeft:"4%", flexDirection:"row", alignSelf:"center", width:"70%", justifyContent:"space-between"}}> */}
                  ...
                  <View style = {{display :"flex",justifyContent: "space-between", width:"100%", marginLeft:"10%"}}>
           ...
           <View style = {{backgroundColor:"#000000aa", flex:1}}>
              ...
              <Text style = {{fontSize:20, fontWeight:"600"}}>Enter Address</Text>
                ...
                <TouchableOpacity style = {styles.btn1} onPress={() => this.saveOriginData(this.state.city, this.state.pinCode)}>
...
export default RefrigeratedCargoAddressToPort;