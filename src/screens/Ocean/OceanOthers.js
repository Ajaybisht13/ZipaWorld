...
class OceanOthers extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
navigatePage = (queryFor, tarrifMode) => {
  ...
  {
    this.props.navigation.navigate("OthersPortToPort", {activityType:"Port To Port", additionalService:this.state.additionalService, queryFor , tarrifMode})
  } else if(this.state.activityType == "Door To Port")
  {
    this.props.navigation.navigate("OthersAddressToPort", {activityType:"Door To Port", additionalService:this.state.additionalService1, queryFor , tarrifMode})
  } else if(this.state.activityType == "Door To Door")
  {
    this.props.navigation.navigate("OthersAddressToAddress", {activityType:"Door To Door", additionalService:this.state.additionalService2, queryFor , tarrifMode})
  } else if(this.state.activityType == "Port To Door")
  {
    this.props.navigation.navigate("OthersPortToAddress", {activityType:"Port To Door", additionalService:this.state.additionalService3, queryFor , tarrifMode})
  } else {
