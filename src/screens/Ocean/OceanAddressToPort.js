...
class OceanAddressToPort extends Component {
...
onChangePin = (text) => {
  fetch(baseUrl + "api/auth/masters/pickupOrigins/managerPincode", {
    ...
    .catch((error) => console.log("error", error));
     ...
     let matches = []
     if(text.length > 2){
    //  matches = this.state.pinCodes && this.state.pinCodes.map((codes, i) => {
    //      return codes.pincode.map((pincodes, ind) => {
    //       const regex = new RegExp(`${text}`, "gi");
    ...
    if(matches.length > 0){
      this.setState({pinSuggestion: matches}, () => {
        console.log("aaaa", this.state.pinSuggestion)
      })
    }
  ...
  onSuggestHandlepin = (text, i) => {
    ...
    saveOriginData = (pickPinCode, city) => {
      let obj = {}
      obj.addressLine2 = ""
      obj.pincode =  pickPinCode,
      obj.city = city,
      obj.state= "",
      obj.country= ""
           ...
           <View style = {{backgroundColor:"#000000aa", flex:1}}>
              ...
              <Text style = {{fontSize:20, fontWeight:"600"}}>Enter Address</Text>
                ...
                { this.state.pinSuggestion && this.state.pinSuggestion.map((item , i) => {
                   console.log("pinSuggestionnnnnnnnnn", item)
                     return (
                       <View>
                ...
                <TouchableOpacity style = {styles.btn1} onPress={() => this.saveOriginData(this.state.pickPinCode, this.state.city)}>
...
export default OceanAddressToPort;