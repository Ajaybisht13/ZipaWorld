...
class OceanDimensions extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
navigatePage = (queryFor, tarrifMode) => {
  ...
  {
    this.props.navigation.navigate("DimentionPortToPort", {activityType:"Port To Port", additionalService:this.state.additionalService, queryFor , tarrifMode})
  } else if(this.state.activityType == "Door To Port")
  {
    this.props.navigation.navigate("DimentionAddressToPort", {activityType:"Door To Port", additionalService:this.state.additionalService1, queryFor , tarrifMode})
  } else if(this.state.activityType == "Door To Door")
  {
    this.props.navigation.navigate("DimentionAddressToAddress", {activityType:"Door To Door", additionalService:this.state.additionalService2, queryFor , tarrifMode})
  } else if(this.state.activityType == "Port To Door")
  {
    this.props.navigation.navigate("DimentionPortToAddress", {activityType:"Port To Door", additionalService:this.state.additionalService3, queryFor , tarrifMode})
  } else {
...
export default OceanDimensions;
