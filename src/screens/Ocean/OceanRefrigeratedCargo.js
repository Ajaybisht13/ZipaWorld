...
class OceanRefrigeratedCargo extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
navigatePage = (queryFor, tarrifMode) => {
  ...
  {
    this.props.navigation.navigate("RefrigeratedCargoPortToPort", {activityType:"Port To Port", temperature: this.state.temperature, additionalService:this.state.additionalService, queryFor , tarrifMode})
  } else if(this.state.activityType == "Door To Port")
  {
    this.props.navigation.navigate("RefrigeratedCargoAddressToPort", {activityType:"Door To Port", temperature: this.state.temperature, additionalService:this.state.additionalService1, queryFor , tarrifMode})
  } else if(this.state.activityType == "Door To Door")
  {
    this.props.navigation.navigate("RefrigeratedCargoAddressToAddress", {activityType:"Door To Door", temperature: this.state.temperature, additionalService:this.state.additionalService2, queryFor , tarrifMode})
  } else if(this.state.activityType == "Port To Door")
  {
    this.props.navigation.navigate("RefrigeratedCargoPortToAddress", {activityType:"Port To Door", temperature: this.state.temperature, additionalService:this.state.additionalService3, queryFor , tarrifMode})
  } else {
...
export default OceanRefrigeratedCargo;
