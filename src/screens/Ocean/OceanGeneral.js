...
class OceanGeneral extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
//     if(token){
//       this.props.navigation.navigate("OceanGeneralStep1")
//     }else {
//      console.log("error")
//     }
//  }
...
navigatePage = (queryFor, tarrifMode) => {
  ...
  {
    this.props.navigation.navigate("OceanGeneralStep1", {activityType:"Port To Port", additionalService:this.state.additionalService, queryFor , tarrifMode})
  } else if(this.state.activityType == "Door To Port")
  {
    this.props.navigation.navigate("OceanAddressToPort", {activityType:"Door To Port", additionalService:this.state.additionalService1, queryFor , tarrifMode})
  } else if(this.state.activityType == "Door To Door")
  {
    this.props.navigation.navigate("OceanAddressToAddress", {activityType:"Door To Door", additionalService:this.state.additionalService2, queryFor , tarrifMode})
  } else if(this.state.activityType == "Port To Door")
  {
    this.props.navigation.navigate("OceanPortToAddress", {activityType:"Port To Door", additionalService:this.state.additionalService3, queryFor , tarrifMode})
  } else {
      ...
      <View style = {{padding:"2%",height:"100%", backgroundColor:"transparent", marginTop:"10%", display:"flex", flexDirection:"column", justifyContent:"space-between", paddingBottom:"30%"}}>  
       <TouchableOpacity style={this.state.borderColorId === 1? styles.border : styles.button} onPress={() => this.Select(1)}> 
        ...
        <View style= {{alignSelf:"center"}}>
            ...
            <Text style = {{fontWeight:"700", fontSize: 18}}>Origin Address To Destination Address</Text>
          </View>  
        </TouchableOpacity>
        ...
        {/* <TouchableOpacity style = {styles.btn} onPress = {() => this.props.navigation.navigate("Ocean", queryFor)}>
               <Icon name= "arrow-left" color="#000000" size={50}/>
            </TouchableOpacity> */}
            <TouchableOpacity style = {styles.btn} onPress = {() => this.navigatePage(queryFor,tarrifMode )}>
            ...
            <Modal transparent={true} visible={this.state.show} animationType="slide">
              <View style = {{backgroundColor:"#000000aa", flex:1}}>
                ...
                {/* <Picker
                  selectedValue={this.state.additionalService}
                  style={{height: 50, width: "100%"}}
                  onValueChange={(itemValue, itemIndex) =>this.setState({additionalService: itemValue})}>
                  <Picker.Item label="Ocean Freight" value="Ocean Freight" />
                </Picker> */}
                <Text></Text>
            ...
            <Modal transparent={true} visible={this.state.show1} animationType="slide">
              <View style = {{backgroundColor:"#000000aa", flex:1}}>
                ...
                <Text></Text>
                 <TouchableOpacity style = {styles.btn1} onPress={() => this.setState({show1:false})}>
                    <View style = {{ alignSelf:"center"}}>
                        <Text style = {{fontWeight:"400", fontSize:23, color:"#ffffff"}}>Next</Text>
                    </View>
                  </TouchableOpacity>   
            ...
            <Modal transparent={true} visible={this.state.show2} animationType="slide">
              <View style = {{backgroundColor:"#000000aa", flex:1}}>
                ...
                <Text></Text>
                 <TouchableOpacity style = {styles.btn1} onPress={() => this.setState({show2:false})}>
                    <View style = {{ alignSelf:"center"}}>
                        <Text style = {{fontWeight:"400", fontSize:23, color:"#ffffff"}}>Next</Text>
                    </View>
                  </TouchableOpacity>   
