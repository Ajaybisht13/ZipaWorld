...
class OceanGeneralStep1 extends Component {
  ...
  componentDidMount = async() => {
    ...
    const csBuddyBranchId = await AsyncStorage.getItem("csBuddyBranchId")
    const authCSBuddyBranchId = await AsyncStorage.getItem("authCSBuddyBranchId")
    console.log("token",token);
    if(token){
      //this.getAllBranch(token);
      this.setState({customerId : authId, customerBranchId : authCustomerBranchId, branchId:authCSBuddyBranchId})
    }else {
      this.setState({customerId : guestId, customerBranchId : customerBranchId, branchId:csBuddyBranchId})
    }
    this.getData();
    //this.companyShipper();
          ...
          <View style = {{display:"flex", flexDirection:"column", padding :"2%",justifyContent:"space-between", marginTop:"10%", height:"100%", paddingBottom:"25%"}}>
           ...
           <TouchableOpacity style={this.state.borderColorId === 1? styles.border : styles.button} onPress={() => this.Select(1)}>
            ...
            <TouchableOpacity style={this.state.borderColorId === 2? styles.border : styles.button} onPress={() => this.Select(2)}>
              ...
              <View style = {{display:"flex", flexDirection:"row", alignSelf:"center", width:"80%", justifyContent:"space-between", marginTop:"3%"}}>
            ...
            <View style = {{ alignSelf:"center", width:"100%"}}>
              <View style = {{display:"flex", flexDirection:"row", justifyContent:"flex-start", marginTop:"2%"}}>
            ...
            <TouchableOpacity style={this.state.borderColorId === 5? styles.border : styles.button} onPress={() => this.Select(5)}>
              <View style = {{display:"flex", flexDirection:"row", alignSelf:"center", width:"70%", justifyContent:"space-between",marginTop:"3%"}}>
