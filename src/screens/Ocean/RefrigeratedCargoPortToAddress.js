...
class RefrigeratedCargoPortToAddress extends Component {
...
onChangePin = (text) => {
  ...
  saveDestinationData = (city, pickPinCode ) => {
    let obj = {}
    obj.addressLine2 = "",
          ...
          <View style = {{display:"flex", flexDirection:"column", padding :"2%",justifyContent:"space-between", marginTop:"10%", height:"100%", paddingBottom:"25%"}}>
           ...
           <View style = {{backgroundColor:"#000000aa", flex:1}}>
              ...
              <Text style = {{fontSize:20, fontWeight:"600"}}>Enter Address</Text>
                ...
                <TouchableOpacity style = {styles.btn1} onPress={() => this.saveDestinationData(this.state.city, this.state.pickPinCode)}>
...
export default RefrigeratedCargoPortToAddress;